...
public class textSimilarity {
    ...
    public static void main(String[] args) {
        String str1="看了不少答案，想了一下，想说两句我今年16岁，9岁时得的病。这些年跑过不少地方，用过不少方子不出所料，屁用没有这几年也看开了，上学外出也习惯了打针忌嘴 但是!我想说一件事好久了! 老子是在打针!不是吸毒!麻蛋不要偶然撞见就一脸“啊，fhr想不到你是这样的人”的表情";
        String str2="糖尿病，被称富贵病，是极其烧钱的一种病，目前无法完全治愈，并发症特别多（我身边的大多是脚部坏死，心脏不好和前列腺有问题的，几个月前，在医院见到一个并发症严重的，半条腿都废了）";
        TextSimilarity textSimilarity = new JaroWinklerDistanceTextSimilarity();
        double score1pk1 = textSimilarity.similarScore(str1, str2);
